...
def write_single_paper(
    ...
    if not writer_model_name or not reflection_model_name:
        raise ValueError("PaperOrchestra requires catalog-bound text model identities")
