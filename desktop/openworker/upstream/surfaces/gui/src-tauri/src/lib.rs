...
use commands::{
    batch_set_skill_tools, check_sync_status, clear_llm_provider, clear_risk_cache_command,
    clear_translation_cache, clear_usage_stats, create_custom_tool, create_directory, create_file,
...
pub fn run() {
    ...
    builder
        ...
        .setup(move |app| {
            ...
            let open_i = MenuItem::with_id(app, "open", "Open Vegapunk", true, None::<&str>)?;
        ...
        .expect("error while building the Vegapunk desktop app")
        .run(|app, event| {
