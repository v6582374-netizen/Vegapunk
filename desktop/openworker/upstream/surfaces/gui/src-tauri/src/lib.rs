...
use commands::{
    ...
    create_custom_tool, create_directory, create_file, create_skill, delete_custom_tool,
    delete_path, delete_skill, detect_available_editors, detect_tools, disable_skill, enable_skill,
    exchange_github_auth, exchange_google_auth, export_skills, fetch_clawhub_skill_files,
    ...
    list_skills, logout_auth, mark_initialized, open_in_editor, preview_import_skills,
        ...
        .setup(move |app| {
            #[cfg(desktop)]
            {
                ...
                for scheme in ["skills-manager", "skillsmanager"] {
                    let _ = app.deep_link().is_registered(scheme);
                }
            }
