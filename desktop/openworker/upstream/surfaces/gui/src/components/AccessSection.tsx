...
// hosted inline in the section so connecting never navigates away. An MCP-backed connect
// completes out-of-band (browser → local OAuth), so poll until the connector flips.
