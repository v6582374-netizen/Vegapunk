...
import {
  ...
  logoutAuth,
  type AuthProvider,
} from "@skills-manager/services/auth";
import { buildAuthErrorMessage } from "@skills-manager/services/authError";
import type { AppConfig, AuthProfile } from "@skills-manager/types";
