...
import feishuGroupQrCode from "@skills-manager/assets/group/feishuqun.png";
import wechatGroupQrCode from "@skills-manager/assets/group/weixinqun.png";
import { submitFeedback } from "@skills-manager/services/feedback";
import {
  FEEDBACK_CONTACT_TYPES,
  FEEDBACK_CONTACT_TYPE_LABEL_KEY_MAP,
  getFeedbackContactValuePlaceholderKey,
  validateFeedbackContact,
} from "@skills-manager/services/feedbackContact";
import {
  FEEDBACK_GROUP_CONTACT_CHANNELS,
  type FeedbackGroupContactChannelId,
} from "@skills-manager/services/feedbackDirectContacts";
...
import type { FeedbackContactType } from "@skills-manager/types";
