...
Vegapunk and PaperOrchestra will use one project-wide Model Provider resolution and runtime path for every in-process LLM call, instead of maintaining a PaperOrchestra-specific factory or provider boundary.
...
- PaperOrchestra becomes a consumer of the same runtime contract as the rest of Vegapunk.
