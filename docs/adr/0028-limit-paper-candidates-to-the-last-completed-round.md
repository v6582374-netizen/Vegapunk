...
- Use InternAgent's recorded `final_best_code_path` directly. Rejected because that path is selected before the last round and does not identify one of the final round's newly executed Candidate Experiments.
