...
- Preserve the upstream Gemini client alongside InternAgent's OpenAI client. Rejected because it would retain two provider stacks inside the integrated workflow.
