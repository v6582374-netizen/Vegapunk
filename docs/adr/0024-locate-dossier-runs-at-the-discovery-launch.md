...
- Add `paper_orchestra_runs/` beneath the selected Candidate Experiment. Rejected because it writes PaperOrchestra-owned state into an Vegapunk experiment directory that must remain read-only.
