...
The local Unified Workspace will persist each Researcher Model Credential through a Secret Store abstraction backed by the operating system credential vault.
...
- The workspace can report, replace, test, and delete a credential without reading its plaintext value back to the browser.
