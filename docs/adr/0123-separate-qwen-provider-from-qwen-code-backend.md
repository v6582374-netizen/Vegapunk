...
Vegapunk will integrate Qwen as a first-class Model Provider and Qwen Code as a separate first-class Experiment Backend alongside Claude Code and iFlow.
