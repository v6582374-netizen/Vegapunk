...
The Dossier Run persists the successful candidate pool, the absence of comparable values, the fact that random selection was used, and the selected candidate before writing begins. Resuming the same Dossier Run reuses that recorded selection rather than drawing again. The random choice remains mandatory Candidate Selection Provenance; ADR-0052 governs whether it is scientifically relevant to the manuscript rather than requiring it to appear there by default.
