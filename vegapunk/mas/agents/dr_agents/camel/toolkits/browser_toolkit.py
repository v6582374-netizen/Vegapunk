...
class AsyncBaseBrowser:
    def __init__(self, headless: bool = True, cache_dir: Optional[str] = None):
        ...
        # Defer Playwright creation to async_init to keep it in the same thread/loop
    ...
    async def async_init(self) -> None:
        ...
        # Create and start Playwright within this event loop/thread
    ...
    async def async_close(self) -> None:
        r"""Asynchronously close page, context, browser and stop Playwright."""
        try:
            ...
            if getattr(self, "playwright_started", False) and self.playwright is not None:
                try:
    ...
    def close(self) -> None:
        r"""Return the coroutine for closing to support awaiting in async contexts."""
