"""
Base Agent Interface for Vegapunk Multi-Agent System

This module provides the foundational abstract base class (BaseAgent) that defines
the interface and common functionality for all specialized agents in the Vegapunk
...
class BaseAgent(abc.ABC):
    ...
    the Vegapunk multi-agent system. Each agent encapsulates a specific cognitive
