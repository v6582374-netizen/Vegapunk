...
from vegapunk.mas.memory.retriever import HybridRetriever
from vegapunk.mas.agents.exp_analyze_agent import ExpAnalyzeAgent, get_metric_direction_by_pattern as get_metric_direction
import asyncio
...
class TaskMemoryLayer:
    ...
    def from_config(cls, config: Dict[str, Any]) -> 'TaskMemoryLayer':
        ...
        This factory method enables consistent initialization from Vegapunk's
        configuration system.

        Args:
            config: Configuration dictionary following Vegapunk pattern:
                {
                    "task_memory": {
