...
- [ ] Conversion is explicit, uses the current default text model and Discovery Input Conversion Prompt, and does not start a Discovery Launch.
- [ ] The long Formatted Discovery Input opens in a right-side editor where the Sole Researcher can review and modify it.
- [ ] Only an explicit save creates a reusable saved input revision for later launch selection.
