...
- [ ] The archive lists running and completed Launches and selects exactly one observation context at a time.
- [ ] Selecting or reconnecting to a Launch replays its complete merged stdout and stderr history before appending live output.
- [ ] The central console leaves Version 1 output raw, without summarizing, redacting, truncating, paginating, or transforming it.
